import {
  Action, Resource, Principal, PRINCIPAL,
...
import { PolicyStorage as PolicyStorage } from './interfaces/policy-storage';
import { CoreHelper } from './helpers/core';

export class Firewall extends CoreHelper {
  constructor(public readonly storage: PolicyStorage, public readonly matcher: MatcherInterface,) {
    super();
  }
  ...
  protected async resolve(
    ...
    const principal = <PrincipalObject>this.normalizeDynamicIdentifier(rawPrincipal, PRINCIPAL);
